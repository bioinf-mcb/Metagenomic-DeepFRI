...
# from mDeepFRI.mmseqs import run_mmseqs_search
...
#     assert weights.is_dir(), "DeepFRI weights should be a directory, not a file."

#     config_path = weights / "model_config.json"
#     assert config_path.exists(), "DeepFRI weights are missing model_config.json"
